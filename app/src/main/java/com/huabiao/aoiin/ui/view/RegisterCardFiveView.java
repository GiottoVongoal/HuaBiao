 ...
 * @description 自主注册第五张卡片(服务方式)
 */
public class RegisterCardFiveView extends RegisterCardBaseView implements View.OnClickListener {
    ...
    public RegisterCardFiveView(Context context) {
        super(context);
