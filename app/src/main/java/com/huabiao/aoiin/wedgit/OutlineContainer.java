...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(dip2px(mContext, 2));
        mOutlinePaint.setColor(getResources().getColor(android.R.color.holo_blue_bright));
