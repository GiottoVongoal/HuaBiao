package com.huabiao.aoiin.hellocharts.util;
...
public abstract class ChartUtils {
    ...
    public static final int LINE_COLOR = Color.parseColor("#D5D5DB");
    public static final int[] COLORS = new int[]{COLOR_BLUE, COLOR_VIOLET, COLOR_GREEN, COLOR_ORANGE, COLOR_RED};
    public static final int[] FULL_COLORS = new int[]{Color.parseColor("#F1C330"), Color.parseColor("#F2BE32"), Color.parseColor("#F3B933")
            , Color.parseColor("#F38C40"), Color.parseColor("#B85980"), Color.parseColor("#7D5EA0")};
    ...
    public static int[] getFullColors() {
        return FULL_COLORS;
    }
