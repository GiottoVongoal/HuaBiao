package com.huabiao.aoiin.hellocharts.renderer;
...
import com.huabiao.aoiin.hellocharts.view.Chart;
...
public class LineChartRenderer extends AbstractChartRenderer {
    ...
    public LineChartRenderer(Context context, Chart chart, LineChartDataProvider dataProvider) {
        ...
        screenWidth = DeviceUtils.getScreenWidth(context) / 3 * 2;
    ...
    private void drawSmoothPath(Canvas canvas, final Line line) {
        ...
        linePaint.setShader(line.getGradientToTransparent() ?
                new LinearGradient(0, 0, screenWidth, 0, ChartUtils.getFullColors(),
                        null, Shader.TileMode.CLAMP) : null);
        ALog.i("screenWidth = " + screenWidth);
        canvas.drawPath(path, linePaint);
        if (line.isFilled()) {
            drawArea(canvas, line);
        }
...
//                        line.getFullColor(), Shader.TileMode.MIRROR) :
//                null);
        linePaint.setShader(line.getGradientToTransparent() ?
                new LinearGradient(0, 0, screenWidth, 0, ChartUtils.getFullColors(),
                        null, Shader.TileMode.CLAMP) : null);
