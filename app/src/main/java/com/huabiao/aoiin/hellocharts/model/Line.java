package com.huabiao.aoiin.hellocharts.model;

import android.graphics.PathEffect;

import com.huabiao.aoiin.hellocharts.formatter.LineChartValueFormatter;
import com.huabiao.aoiin.hellocharts.formatter.SimpleLineChartValueFormatter;
...
public class Line {
    ...
    private int fullColor = ChartUtils.DEFAULT_COLOR;
    ...
    public Line setFullColor(int fullColor) {
        this.fullColor = fullColor;
        if (pointColor == UNINITIALIZED) {
            this.darkenColor = ChartUtils.darkenColor(fullColor);
        }
        return this;
    }
