...
import com.huabiao.aoiin.hellocharts.BuildConfig;
import com.huabiao.aoiin.hellocharts.listener.ComboLineColumnChartOnValueSelectListener;
import com.huabiao.aoiin.hellocharts.listener.DummyCompoLineColumnChartOnValueSelectListener;
import com.huabiao.aoiin.hellocharts.model.ChartData;
import com.huabiao.aoiin.hellocharts.model.ColumnChartData;
import com.huabiao.aoiin.hellocharts.model.ComboLineColumnChartData;
...
import com.huabiao.aoiin.hellocharts.provider.ColumnChartDataProvider;
import com.huabiao.aoiin.hellocharts.provider.ComboLineColumnChartDataProvider;
import com.huabiao.aoiin.hellocharts.provider.LineChartDataProvider;
import com.huabiao.aoiin.hellocharts.renderer.ColumnChartRenderer;
import com.huabiao.aoiin.hellocharts.renderer.ComboLineColumnChartRenderer;
import com.huabiao.aoiin.hellocharts.renderer.LineChartRenderer;
...
public class ComboLineColumnChartView extends AbstractChartView implements ComboLineColumnChartDataProvider {
    ...
    public void setComboLineColumnChartData(ComboLineColumnChartData data) {
        if (BuildConfig.DEBUG) {
            ALog.d(TAG, "Setting data for ComboLineColumnChartView");
        }
