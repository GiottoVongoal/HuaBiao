...
/**
 * Created by yangweiyi on 2016/12/23.
 * <pre>
 *     author: Blankj
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(BaseApplication.getContext(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(BaseApplication.getContext(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(BaseApplication.getContext(), resourceId), start, end, flag);
                    resourceId = 0;
