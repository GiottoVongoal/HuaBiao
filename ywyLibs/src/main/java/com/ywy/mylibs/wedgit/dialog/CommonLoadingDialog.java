package com.ywy.mylibs.wedgit.dialog;
...
public class CommonLoadingDialog extends Dialog {
	...
	public CommonLoadingDialog(Context context, String message) {
		...
		ll.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				isForceClosed = true;
				if (callback != null) {
					callback.close(CommonLoadingDialog.this);
				}
			}
		});
	...
	public interface Callback {
		void close(CommonLoadingDialog dialog);
	}
